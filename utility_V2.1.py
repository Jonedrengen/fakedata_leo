...
def gen_whovariant_SampleDate(LineageOfInterest, reference_data):
    """
    ...
    Args:
        ...
        reference_data (pandas.DataFrame - "Complete_reference_data.csv"): Reference dataset containing columns:
            ...
            - SampleDate: Date in 'YYYY-MM-DD' format
    ...
    Example:
        >>> date = gen_whovariant_SampleDate('Alpha', reference_df)
        >>> print(date)
        2021-02-15 00:00:00
    """
...
def generate_BatchSource(LineageOfInterest, SampleDate, reference_data):
    """
    ...
    Args:
        ...
        SampleDate (datetime): The sampling date to match with batch sources
    ...
    Returns:
        str: A batch source identifier (e.g., 'Panem', 'Hogwarts', etc.) selected based on a lineageofinterest and a SampleDate date.
    ...
    mask = (reference_data['LineagesOfInterest'] == LineageOfInterest) & \
           (pd.to_datetime(reference_data['DateSampling']) == SampleDate)
