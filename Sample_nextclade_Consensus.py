...
from utility import write_to_csv, generate_ct_value, gen_whovariant_samplingdate, generate_qc_values, generate_NumbAlignedReads, generate_ncount_value, generate_ambiguoussites
import pandas as pd
...
def SampleData(record_amount, sample_ids, consensus_ids, consensus_essentials):
    ...
    for i in range(record_amount):
        ...
        if lineage_of_interest == "Alpha":
            random_date = gen_whovariant_samplingdate("2020-09-18", "2022-02-01", "2021-04-22", 50) #original sd=501
        elif lineage_of_interest == "Beta":
            random_date = gen_whovariant_samplingdate("2021-01-10", "2021-07-19", "2021-04-03", 12) #original sd=190
        elif lineage_of_interest == "Gamma":
            random_date = gen_whovariant_samplingdate("2020-10-12", "2021-07-30", "2021-04-22", 32) #original sd=291
        elif lineage_of_interest == "Delta":
            random_date = gen_whovariant_samplingdate("2021-03-30", "2022-02-27", "2021-10-12", 33) #original sd=334
        elif lineage_of_interest == "Eta":
            random_date = gen_whovariant_samplingdate("2021-01-14", "2021-07-21", "2021-03-12", 12) #original sd=188
        elif lineage_of_interest == "Omicron":
            random_date = gen_whovariant_samplingdate("2021-02-20", "2022-03-01", "2022-01-26", 34) #original sd=374
        elif lineage_of_interest == "BA.2":
            random_date = gen_whovariant_samplingdate("2021-02-20", "2022-03-01", "2022-02-03", 32) #original sd=374
        elif lineage_of_interest == "BA.1":
            random_date = gen_whovariant_samplingdate("2021-11-22", "2022-03-01", "2022-01-17", 11) #original sd=99
        else:
            random_date = None
